...
#     client = ElevenLabs(
#         api_key= "<sk_6a250febcab063c0a69e3e476f45e74880558cd9da31558d>",
#     )

#     # Calling the text_to_speech conversion API with detailed parameters
#     response = client.text_to_speech.convert(
#         voice_id="ZF6FPAbjXT4488VcRRnw", #clone your voice on elevenlabs dashboard and copy the id
...
# def text_to_speech(text: str) -> str:
#     client = ElevenLabs(
#         api_key="sk_398ddbdca1c4aae101d1a24e6e9481830916a91b31db8549",
#     )
